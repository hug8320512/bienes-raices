...
$ObjetoPropiedades = Properties::createInstance();
$propiedades_exclusivas = $ObjetoPropiedades->getExclusives();
?>
...
<head>
    ...
    <link rel="stylesheet" href="css/responsive.css">
     ...
     <!-- Newslester -->
     <link rel="stylesheet" href="css/newslester.css">
</head>
...
<div class="body-wrapper">    
    ...
    <div class="ltn__slider-area ltn__slider-3  section-bg-2">
        <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1">
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2 ltn__slide-item-3-normal--- ltn__slide-item-3 bg-image bg-overlay-theme-black-60" data-bs-bg="img/slider/500.jpg">
            ...
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2  ltn__slide-item-3-normal--- ltn__slide-item-3 bg-image bg-overlay-theme-black-60" data-bs-bg="img/slider/501.jpg">
            ...
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2  ltn__slide-item-3-normal--- ltn__slide-item-3 bg-image bg-overlay-theme-black-60" data-bs-bg="img/slider/502.jpg">
    ...
    <!-- PRODUCT SLIDER-EXCLUSIVE AREA START -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2--- text-center">
                        ...
                        <h1 class="section-title">PROPIEDADES EXCLUSIVAS</h1>
                    </div>
                </div>
            </div>
            <div class="row ltn__product-slider-item-three-active slick-arrow-1">
            <?php foreach($propiedades_exclusivas as $propiedad):?>
                <!-- ltn__product-item -->
                <div class="col-lg-12">
                    <div class="ltn__product-item ltn__product-item-4 text-center---">
                        <div class="product-img">
                        <a href="product-details.html"><img src="img/slider/500.jpg" alt=""></a>
                            <div class="product-badge">
                            <ul>
                                        <?php if($propiedad['for_sale']):?>
                                            <li class="sale-badge bg-green">Venta</li>
                                        <?php endif;?>
                                        <?php if($propiedad['for_rent']):?>
                                            <li class="sale-badge bg-red">Renta</li>
                                        <?php endif;?>
                                    </ul>
                            </div>
                            <div class="product-img-location-gallery">
                                <div class="product-img-location">
                                    <ul>
                                        <li>
                                            <a href="locations.html"><i class="flaticon-pin"></i><?php echo $propiedad['address'];?></a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="product-info">
                            ...
                            <?php echo number_format($propiedad['price_sale']) . " " . $propiedad['currency_sale'];?></span>
                            </div>
                            <h2 class="product-title"><a href="product-details.html"><?php echo $propiedad['title'];?></a></h2>
                            <div class="product-description">
                                <?php echo $propiedad['short_description'];?>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2--- text-center">
                        ...
                        <h1 class="section-title">TIPOS DE PROPIEDADES</h1>
                    </div>
                </div>
            </div>
    ...
    <!-- PRODUCT SLIDER-VENTAS AREA START -->
    <div class="ltn__product-slider-area ltn__product-gutter pt-115 pb-90">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <!-- NEWSLESTER-AREA -->
    <section class="newslester">
    <div class="contacto" id="contacto">
        <div class="contenedor">
          <div class="contenedor-formulario">
            <div class="formulario" id="formulario">
              <h2>Newsletter </h2>
              <p>Suscribete para recibir nuestro contenido.</p>
              <form>
                <div>
                ...
                <div>
                  <input type="submit" name="enviar" value="Suscribir">
                </div>
              </form>
            </div>
...
<!-- PRODUCT SLIDER-RENTA AREA START -->
<div class="ltn__product-slider-area ltn__product-gutter pt-115 pb-90">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2--- text-center">
                        <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">Properties</h6>
                        <h1 class="section-title">PROPIEDADES EN RENTA</h1>
                    </div>
                </div>
            </div>
            <div class="row ltn__product-slider-item-three-active slick-arrow-1">
